...
export default function LoginAdmin() {
    ...
    return (
        <div className="relative w-full h-svh">
            ...
            <div className="relative flex text-[24px] z-20 top-16 w-full h-4/5 text-center items-center justify-center">
                <Formik
                ...
                >
                    {({ isSubmitting }) => (
                        <Form className="flex flex-col p-4 gap-5 w-[350px] items-center">
                            ...
                            <p className='font-light text-[12px] w-[300px]'>Manage your events on <span className='font-medium'>NexVent</span>, or <a className='font-bold underline' href='/register-admin'>Create Event Organizer</a></p>
